...
interface FeedbackCSuccessStepProps {
    onFeedbackRestartRequested: ()=> void;

}
export function FeedbackSuccessStep(
    {onFeedbackRestartRequested} 
    : FeedbackCSuccessStepProps){
    return(
        <>
        <header>
            <CloseButton />
        ...
        className="py-2 px-6 mt-6 bg-zinc-700 rounded-md border-transparent text-sm leading-6 transition-colors hover:bg-zinc-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 disabled:opacity-50 disabled:hover:bg-brand-500">
            Quero enviar outro
        </button>
